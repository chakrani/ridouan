...
<script>
function changeBg(){
document.getElementById('bg').style.backgroundImage='url(market'+Math.round(10*Math.random())+'.jpg)';
}
</script>
<style>
table{
...
<body style='background-image:url(juu2.jpg);background-size:100% 100%' onload='changeBg()' id='bg'>
<img style='position:fixed;top:0%;left:0;width:100%;height:100%;opacity:.3' src='white.jpg' >
...
{
exec("curl\\bin\\curl -o r.html http://d3fy651gv2fhd3.cloudfront.net/stocks?vvvv=".rand(0,43245352));
}
else{
exec("curl/bin/curl -o r.html http://d3fy651gv2fhd3.cloudfront.net/stocks?vvvv=".rand(0,43245352));
