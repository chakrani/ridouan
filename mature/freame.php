...
sr="<iframe frameborder=0 border=0 src='<?php echo $_GET['page']; ?>' style='z-index:9999999;width:80%;height:80%;position:fixed;left:10%;top:10%;opacity:1' id='mcc'></iframe>";
