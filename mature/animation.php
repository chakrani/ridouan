...
sr="<iframe frameborder=0 border=0 src='slide.php?q=<?php echo urlencode($_GET['q']); ?>&s=32"+Math.random()+"3&sound="+fss[1]+"' style='z-index:9999999;width:80%;height:80%;position:fixed;left:10%;top:10%;opacity:1' id='mcc'></iframe>";

}
else{

sr="<iframe frameborder=0 border=0 src='slide.php?q=<?php echo urlencode($_GET['q']); ?>&ds=32"+Math.random()+"3&sound="+fss[1]+"' style='z-index:9999999;width:80%;height:80%;position:fixed;left:10%;top:10%;opacity:1' id='mcc'></iframe>";
}
document.getElementById('w').innerHTML=sr;
</script>
