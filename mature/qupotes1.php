...
<img id='bg' style='width:100%;height:100%;position:fixed;left:0;top:0'>
...
$ech= file_get_contents("http://d3fy651gv2fhd3.cloudfront.net/commodities?vvvv=".rand(0,43245352));
$tr=explode("<div class=\"panel panel-default\">", $ech);

//for($r=1;$r<2;(count($tr)-1);$r++){

$fs=explode("<h2 id=\"summary\">", $tr[1]);
echo  "<div class=\"panel panel-default\">".$fs[0]."";
